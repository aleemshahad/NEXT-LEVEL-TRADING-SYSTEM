...
```mermaid
graph TD
    A[Autonomous Scraper] -->|News & Social Sentiment| B[Sentiment Intelligence]
    B -->|Macro Bias| C[Trading Brain]
    D[MT5 Live Data] -->|ICT/SMC Patterns| C
    C -->|High Confluence Signal| E[Risk Manager]
    E -->|Optimized Lot Size| F[Trade Execution]
    F -->|Result Tracking| G[Continuous Learning]
    G -->|Update Model| C
```
